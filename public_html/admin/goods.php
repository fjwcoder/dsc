			...
			if (($_REQUEST['act'] == 'insert_link_desc') || ($_REQUEST['act'] == 'update_link_desc')) {
				...
				if (($_REQUEST['act'] == 'insert') || ($_REQUEST['act'] == 'update')) {
					...
					if ($is_insert) {
						...
						$sql = 'UPDATE ' . $ecs->table('goods') . ' SET ' . 'goods_name = \'' . $goods_name . '\', ' . 'goods_name_style = \'' . $goods_name_style . '\', ' . 'goods_sn = \'' . $goods_sn . '\', ' . 'bar_code = \'' . $bar_code . '\', ' . 'cat_id = \'' . $catgory_id . '\', ' . 'brand_id = \'' . $brand_id . '\', ' . 'shop_price = \'' . $shop_price . '\', ' . 'market_price = \'' . $market_price . '\', ' . 'cost_price = \'' . $cost_price . '\', ' . 'is_promote = \'' . $is_promote . '\', ' . 'is_volume = \'' . $is_volume . '\', ' . 'is_fullcut = \'' . $is_fullcut . '\', ' . 'model_price = \'' . $model_price . '\', ' . 'model_inventory = \'' . $model_inventory . '\', ' . 'model_attr = \'' . $model_attr . '\', ' . 'largest_amount = \'' . $largest_amount . '\', ' . 'group_number = \'' . $group_number . '\',' . 'store_new = \'' . $store_new . '\',' . 'store_hot = \'' . $store_hot . '\',' . 'store_best = \'' . $store_best . '\',' . 'goods_unit = \'' . $goods_unit . '\',' . 'is_xiangou=\'' . $is_xiangou . '\',' . 'xiangou_num = \'' . $xiangou_num . '\',' . 'xiangou_start_date = \'' . $xiangou_start_date . '\',' . 'xiangou_end_date = \'' . $xiangou_end_date . '\',' . 'goods_product_tag = \'' . $_POST['goods_product_tag'] . '\', ' . 'goods_tag = \'' . $_POST['goods_tag'] . '\', ' . 'pinyin_keyword = \'' . $pinyin . '\', ' . 'stages = \'' . $stages . '\', ' . 'stages_rate = \'' . $stages_rate . '\', ' . 'user_cat = \'' . $user_cat . '\', ' . $where_drp_up . $freight_update_data . 'promote_price = \'' . $promote_price . '\', ' . 'promote_start_date = \'' . $promote_start_date . '\', ' . 'suppliers_id = \'' . $suppliers_id . '\', ' . 'promote_end_date = \'' . $promote_end_date . '\', ';
